...
<div class="overflow">
    ...
    <div class="main__text" id="content" value="<?php echo e($value['id']); ?>">
        ...
        <div class="main__text-content">
            <div class="main__content-text"><?php echo e($value['message']); ?></div>
            <div class="main__text-time"><?php echo e($value['time']->format('H:m')); ?></div>
...
<?php /**PATH /Users/iamgadfly/Documents/example/resources/views/index.blade.php ENDPATH**/ ?>